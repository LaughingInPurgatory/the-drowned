...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  getSfxVolume: () => ipcRenderer.invoke('get-sfx-volume'),
  setSfxVolume: (volume) => ipcRenderer.invoke('set-sfx-volume', volume),
  getMusicEnabled: () => ipcRenderer.invoke('get-music-enabled'),
  setMusicEnabled: (enabled) => ipcRenderer.invoke('set-music-enabled', enabled),
  getMusicVolume: () => ipcRenderer.invoke('get-music-volume'),
  setMusicVolume: (volume) => ipcRenderer.invoke('set-music-volume', volume),
  getSeaVolume: () => ipcRenderer.invoke('get-sea-volume'),
  setSeaVolume: (volume) => ipcRenderer.invoke('set-sea-volume', volume),
